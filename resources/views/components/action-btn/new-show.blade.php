<td>
    @can('admin.articles.edit')
        <a href="{{route('dashboard.articles.edit' , $record)}}"
    ...
    @can('admin.articles.delete')
        <a class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm delete-btn" data-url="{{route('dashboard.articles.destroy', $record)}}"
