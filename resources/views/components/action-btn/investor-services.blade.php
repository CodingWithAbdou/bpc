                ...
                <div class="modal-body">
                    <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td class="ps-3">{{__('front.ID/Passport/Personal Card Number')}}</td>
                            <td>{{$record->card_id}}</td>
                          </tr>
                          <tr>
                            <td class="ps-3">{{__('front.Residence Address - P.O. Box')}}</td>
                            <td>{{$record->address}}</td>
                          </tr>
                          <tr>
                            <td class="ps-3">{{__('front.Bank/Branch Name')}}</td>
                            <td>{{$record->bank_name}}</td>
                          </tr>
                          <tr>
                            <td class="ps-3">{{__('front.Your Active Account IBAN Number')}}</td>
                            <td>{{$record->iban}}</td>
                          </tr>
                        </tbody>
                      </table>
