    ...
    <div class="card card-flush">
        ...
        <div class="card-body pt-0">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="datatable">
                ...
                <tr>
                    <td>
                        <div class="symbol symbol-100px p-3">
                            <img src="{{asset($data->image_one)}}" alt="" class="object-cover">
                        </div>
                    </td>
                    <td>{{$data->title}}</td>
                ...
                <tr>
                    ...
                    <td>{{getLocale() == 'ar' ? $financial_reports_annual->title_ar : $financial_reports_annual->title_en}}</td>
                ...
                <tr>
                    ...
                    <td>{{getLocale() == 'ar' ? $financial_reports_quarter->title_ar : $financial_reports_quarter->title_en}}</td>
