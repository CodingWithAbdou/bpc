...
@section('content')
    <form id="form-data" action="{{route('dashboard.environment.update')}}" class="form d-flex flex-column flex-lg-row">
        ...
        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px min-w-lg-300px mb-7 me-lg-10">
            <x-inputs.image label="{{__('dash.image of face')}}" name="image_one" required="" class="bg-dark" data="{{isset($data)?$data->image_one:''}}"/>
