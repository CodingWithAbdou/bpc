        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            <div class="card card-flush py-4">
                ...
                <div class="card-body py-0">
                    <x-html.div_loader />
                    <div class="row">
                        <x-inputs.text label="{{__('dash.title of category')}}" name="name" required="" data="{{isset($data)?$data->name:''}}"/>
                        <x-inputs.select label="{{__('dash.type category')}}" name="product_type_id" required="" data="{{isset($data)?$data->product_type_id:''}}"
