<td>
    ...
    <a href="{{route('dashboard.categories.edit', $record)}}"
...
@can('admin.categories.delete')
    <a class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm delete-btn" data-url="{{route('dashboard.categories.destroy', $record)}}"
