        ...
        <div class="card-body pt-0">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="datatable">
                ...
                <tr class="text-start text-dark fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-150px no-column">{{__('dash.description')}}</th>
                ...
                @foreach($data as $record)
                    <tr>
                        ...
                        if($record->section_key == 'sliders') {
                            $actionComponentName = 'action-btn.' . 'sliders';
                        }else if($record->section_key == 'news') {
                            $actionComponentName = 'action-btn.' . 'news';
                        }
                        else {
                            $actionComponentName = 'action-btn.'.$model->route_key ;
                        }
                        @endphp
