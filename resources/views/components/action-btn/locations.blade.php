<td>
    <a href="{{route('dashboard.locations.edit' , $record)}}"
    ...
    <a class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm delete-btn" data-url="{{route('dashboard.locations.destroy', $record)}}"
