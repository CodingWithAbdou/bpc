<td>
    @can('admin.pageAbout.edit')
        <a href="{{route('dashboard.pageOther.edit', $record)}}"
...
{{--        <a class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm delete-btn" data-url="{{route('dashboard.pages.destroy', $record)}}"--}}
