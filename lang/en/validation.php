...
return [
    ...
    */
    ...
    'you shoud agree' => 'You must agree to the condition',
    'You must fill out this field' => 'You must fill out this field',
    ...
    */
    ...
    'attributes' => [
        ...
        'description_ar' => 'Website Description "AR"',
        'description_en' => 'Website Description "EN"',
        'keywords' => 'Keywords',
        'dark_logo' => 'Dark Logo',
        ...
        'aboard_phone' => 'Abroad phone number',
        'whatsapp' => 'whats up number',
        'Fax' => 'Fax',
        ...
        'full_name' => 'Full Name',
        'Degree.*' => 'Degree Requerd',


        'specialization.*' => 'Specialization is required.',
        'university.*' => 'University is required.',
        'dob.*' => 'Year of graduation is required.',

        'language.*' => 'Language is required.',
        'reading.*' => 'Reading proficiency is required.',
        'writing.*' => 'Writing proficiency is required.',
        'speaking.*' => 'Speaking proficiency is required.',

        'programs.*' => 'Program is required.',
        'experience.*' => 'Experience is required.',

        'course_names.*' => 'Course name is required.',
        ...
        'salary_starting.*' => 'Starting salary is required.',
        'salary_ending.*' => 'Ending salary is required.',
        'period_from.*' => 'Period from is required.',
        'period_to.*' => 'Period to is required.',
        'reason_for_leave.*' => 'Reason for leaving is required.',

        'desc_suffer' => 'Description of illness is required.',
        'has_suffer' => 'Illness information is required.',
