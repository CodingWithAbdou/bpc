        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            <div class="card card-flush py-4">
                ...
                <div class="card-body py-0">
                    <div class="row">
                        <x-inputs.text label="{{__('dash.name')}} 'Ar'" name="name_ar" required="" data="{{isset($data)?$data->name_ar:''}}"/>
                        <x-inputs.text label="{{__('dash.name')}} 'En'" name="name_en" required="" data="{{isset($data)?$data->name_en:''}}"/>
                        <x-inputs.text label="{{__('dash.name')}} 'Fr'" name="name_fr" required="" data="{{isset($data)?$data->name_fr:''}}"/>
                    </div>
                </div>
            </div>
