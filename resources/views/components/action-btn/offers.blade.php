<td>
    ...
    @endcan
    @can('admin.offers.delete')
        <a class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm delete-btn" data-url="{{route('dashboard.offers.destroy', $record)}}"
