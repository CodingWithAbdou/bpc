...
@section('content')
    <form id="form-data" action="{{route('dashboard.stok-price.update')}}" class="form d-flex flex-column flex-lg-row" >
        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            <div class="card card-flush py-4">
                ...
                <div class="card-body py-0">
                    <x-html.div_loader />
                    <div class="row">
                        <x-inputs.text label="{{__('dash.subtitle')}}" name="subtitle" required="" data="{{isset($data)?$data->subtitle:''}}"/>
                        <x-inputs.number label="{{__('dash.price')}}" name="price" required="" data="{{isset($data)?$data->price:''}}"/>
                        <x-inputs.number label="{{__('dash.percent')}}" name="percent"  data="{{isset($data)?$data->percent:''}}"/>
                        <x-inputs.text label="{{__('dash.info')}}" name="info" required="" data="{{isset($data)?$data->info:''}}"/>
                        <x-inputs.textarea class="editor" label="{{__('dash.description')}}" name="description" required="" data="{!! isset($data)?$data->description:'' !!}"/>
                        <x-inputs.text label="{{__('dash.link')}}" name="link" required="" data="{{isset($data)?$data->link:''}}"/>
