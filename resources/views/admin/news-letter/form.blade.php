...
@section('content')
    <form id="form-data" action="{{route('dashboard.'.$model->route_key.'.update', $data)}}" class="form d-flex flex-column flex-lg-row">
        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            <div class="card card-flush py-4">
                ...
                <div class="card-body py-0">
                    <x-html.div_loader />
                    <div class="row">
                        <x-inputs.text label="{{__('dash.message arbic')}}" name="message_ar" required="" data="{{isset($data)?$data->message_ar:''}}"/>
                        <x-inputs.text label="{{__('dash.message english')}}" name="message_en" required="" data="{{isset($data)?$data->message_en:''}}"/>
