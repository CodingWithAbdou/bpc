            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body py-0">
                    ...
                    <div class="row">
                        ...
                        <x-inputs.text label="{{__('dash.phone')}}" name="phone" required="" data="{{isset($data)?$data->phone:''}}"/>
                        <x-inputs.textarea label="{{__('dash.address')}}" name="address" required="" data="{{isset($data)?$data->address:''}}"/>
                    </div>
                </div>
            </div>
